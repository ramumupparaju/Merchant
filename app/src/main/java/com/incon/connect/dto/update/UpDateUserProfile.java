package com.incon.connect.dto.update;
...
import static com.incon.connect.AppConstants.UpDateUserProfileValidation.DOB_FUTURE_DATE;
import static com.incon.connect.AppConstants.UpDateUserProfileValidation.DOB_PERSON_LIMIT;
        ...
        switch (id) {
            case 0:
                if (emptyValidation && TextUtils.isEmpty(getName())) {
                    return AppConstants.UpDateUserProfileValidation.NAME_REQ;
                }
                break;
            ...
            case 1:
                ...
                if (emptyValidation && phoneEmpty) {
                    return AppConstants.UpDateUserProfileValidation.PHONE_REQ;
                } else if (!phoneEmpty && !ValidationUtils.isPhoneNumberValid(getPhoneNumber())) {
                    return AppConstants.UpDateUserProfileValidation.PHONE_MIN_DIGITS;
                }
                break;
            ...
            case 2:
                ...
                if (emptyValidation && genderTypeEmpty) {
                    return AppConstants.UpDateUserProfileValidation.GENDER_REQ;
                }
                break;
            ...
            case 3:
                ...
                if (emptyValidation && dobEmpty) {
                    return AppConstants.UpDateUserProfileValidation.DOB_REQ;
                } else if (!dobEmpty) {
                    return validateDob();
                }
                break;
            ...
            case 4:
                ...
                if (emptyValidation && emailEmpty) {
                    return AppConstants.UpDateUserProfileValidation.EMAIL_REQ;
                } else if (!emailEmpty && !ValidationUtils.isValidEmail(getEmailId())) {
                    return AppConstants.UpDateUserProfileValidation.EMAIL_NOTVALID;
                }
                break;
            ...
            case 5:
                ...
                if (emptyValidation && passwordEmpty) {
                    return AppConstants.UpDateUserProfileValidation.PASSWORD_REQ;
                } else if (!passwordEmpty && !ValidationUtils
                        .isPasswordValid(getPassword())) {
                    return AppConstants.UpDateUserProfileValidation.PASSWORD_PATTERN_REQ;
                }
                break;
            ...
            case 6:
                ...
                if (emptyValidation && reEnterPasswordEmpty) {
                    return AppConstants.UpDateUserProfileValidation.RE_ENTER_PASSWORD_REQ;
                    ...
                    if (passwordEmpty1 || (!getPassword()
                        ...
                        return AppConstants.UpDateUserProfileValidation
            ...
            case 7:
                ...
                if (emptyValidation && userAddress) {
                    return AppConstants.UpDateUserProfileValidation.ADDRESS_REQ;
                }
                break;
        ...
        switch (id) {
            ...
            case 2:
                ...
                if (emptyValidation && storeCategory) {
                    return AppConstants.UpDateUserProfileValidation.CATEGORY_REQ;
                }
                break;
            ...
            case 5:
                ...
                if (emptyValidation && storeGstn) {
                    return AppConstants.UpDateUserProfileValidation.GSTN_REQ;
                }
                break;
